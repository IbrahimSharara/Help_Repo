/*
 * <input type="text" name="StopSalesDate" class="form-control flatpickr-input" id="date" placeholder="Choose date" readonly="readonly">
 * here change id to (date or datetime or  humanfrienndlydate ...)
 * \
